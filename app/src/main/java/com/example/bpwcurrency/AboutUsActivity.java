...
public class AboutUsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        drawerLayout = findViewById(R.id.aboutUs_layout);
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                switch (menuItem.getItemId()) {
                    case R.id.home_menu:
                        Intent intentHome = new Intent(AboutUsActivity.this, MainActivity.class);
                        startActivity(intentHome);
                        break;
                    case R.id.login_menu:
                        Intent intentLogin = new Intent(AboutUsActivity.this, LoginActivity.class);
                        drawerLayout.closeDrawer(GravityCompat.START);
                        startActivity(intentLogin);
                        break;
                    case R.id.register_menu:
                        Intent intentRegis = new Intent(AboutUsActivity.this, RegisterActivity.class);
                        drawerLayout.closeDrawer(GravityCompat.START);
